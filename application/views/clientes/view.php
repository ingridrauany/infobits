<h2 class="content__title">Cliente</h2>
<div class="content__view">
    ...
    <div class="form_buttons">
        <a href="<?= base_url("clientes") ?>" alt="Listar Clientes" class="btn btn--cancel">Voltar</a>
        <a href="<?= base_url("clientes/print/{$cliente['id']}") ?>" class="btn btn-submit">Imprimir <i class='fa fa-print' aria-hidden='true'></i></a>
    </div>
</div>
